...
from pympler import \
    asizeof  ## Pympler is a development tool to measure, monitor and analyze the memory behavior of Python objects in a running Python application.
import numpy as np
import pandas as pd
...
class SeqContextKNN:
    ...
    def __init__(self, k, sample_size=1000, sampling='recent', similarity='jaccard', weighting='div', remind=False,
                 pop_boost=0, extend=False, normalize=True, session_key='session_id', item_key='reference',
                 time_key='timestamp'):
