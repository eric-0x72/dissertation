...
PATH_TO_ORIGINAL_DATA = 'D:/pycharm_workspace/dataset/rsc_2015/'
PATH_TO_PROCESSED_DATA = 'D:/pycharm_workspace/dataset/rsc_2015/'
...
data['Time'] = data.TimeStr.apply(lambda x: dt.datetime.strptime(x,
                                                                 '%Y-%m-%dT%H:%M:%S.%fZ').timestamp())  # This is not UTC. It does not really matter.
del (data['TimeStr'])
